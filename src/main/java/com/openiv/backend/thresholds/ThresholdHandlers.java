...
public final class ThresholdHandlers {
  ...
  private static JsonObject tierJson(KycTierRecord t) {
    return new JsonObject()
        ...
        .put("dailyLimitWireInward",               t.dailyLimitWireInward())
        .put("dailyLimitWireOutward",              t.dailyLimitWireOutward())
        .put("dailyLimitMobileInward",             t.dailyLimitMobileInward())
        .put("dailyLimitMobileOutward",            t.dailyLimitMobileOutward())
        .put("dailyLimitUssdInward",               t.dailyLimitUssdInward())
        .put("dailyLimitUssdOutward",              t.dailyLimitUssdOutward())
        .put("dailyLimitBdcInward",                t.dailyLimitBdcInward())
        .put("dailyLimitBdcOutward",               t.dailyLimitBdcOutward())
        .put("dailyLimitOtherInward",              t.dailyLimitOtherInward())
        .put("dailyLimitOtherOutward",             t.dailyLimitOtherOutward())
