 ...
 * <p>Layout rules:
 * <ul>
 *   <li>Table-based structure — most email clients (Outlook, Gmail, Apple Mail) ignore CSS
 *       floats and flex; nested tables are the only reliable layout primitive.</li>
 *   <li>All styles are inlined — external/embedded stylesheets are stripped by many webmail
 *       clients before rendering.</li>
 *   <li>max-width 580 px — fits every common viewport without horizontal scroll.</li>
 *   <li>A hidden preheader line is injected so inbox preview text is controlled.</li>
 * </ul>
 */
public final class EmailTemplates {
  ...
  public static String stepUpLockoutAdmin(String adminName, String userName,
    ...
    return wrap("Security Alert — Step-Up Lockout", "A user in your institution has been locked out.",
        ...
        + dataTable(DANGER, "Lockout Event", new String[][]{
            ...
            { "Reason", "<span style=\"color:" + DANGER + ";font-weight:600;\">3 failed TOTP step-up attempts</span>" },
  ...
  public static String caseNotification(String caseId, String caseTitle,
    ...
    return wrap("Fraud Investigation Case Opened", "A new case requires your attention.",
        ...
        + dataTable(priorityColor, "Case Opened", new String[][]{
            ...
            { "Priority", "<span style=\"color:" + priorityColor + ";font-weight:600;text-transform:uppercase;\">" + esc(priority) + "</span>" },
  ...
  public static String institutionInvite(String contactName, String institutionName,
    ...
    return wrap("You're Invited to OpenIV", "Your institution has been approved on the platform.",
        ...
        + "<p style=\"font-size:13px;font-weight:600;color:" + MUTED + ";margin:24px 0 8px;\">YOUR INVITATION CODE</p>"
  ...
  public static String welcome(String recipientName, String institutionName) {
    return wrap("Welcome to OpenIV — Your Account Is Ready",
        ...
        + p("Questions? Reach out to your team administrator or contact us at "
            + "<a href=\"mailto:support@openiv.ng\" style=\"color:" + BRAND + ";\">"
            + "support@openiv.ng</a>.")
  ...
  private static String codeBlock(String code) {
    return "<div style=\"background:#f1f5f9;border:1px solid " + BORDER + ";padding:24px;text-align:center;margin:20px 0;\">"
  ...
  private static String wrap(String title, String preheader, String body) {
    return "<!DOCTYPE html>"
        ...
        + " &nbsp;·&nbsp; <a href=\"https://openiv.ng\" style=\"color:" + BRAND + ";text-decoration:none;\">openiv.ng</a>"
        + "</p>"
        + "</td></tr>"
        ...
        + "<a href=\"mailto:support@openiv.ng\" style=\"color:" + BRAND + ";text-decoration:none;\">support@openiv.ng</a>."
        + "</p>"
