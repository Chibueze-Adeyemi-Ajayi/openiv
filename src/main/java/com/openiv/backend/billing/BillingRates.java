...
public final class BillingRates {
  ...
  public static final long RATE_KYC_LOOKUP        = 500_000L;        // ₦50.00    per lookup
  public static final long RATE_KYC_PEP_LOOKUP   = 5_000_000L;      // ₦500.00   per PEP lookup
  ...
  public static final long RATE_NFIU_RETURN       = 1_000_000L;      // ₦100.00   per filing
