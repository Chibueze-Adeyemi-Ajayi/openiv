    ...
    <Box sx={{ bgcolor: '#0a0f1e', py: 6, borderTop: '1px solid #1e293b' }}>
      <Container maxWidth="lg">
        <Grid container spacing={4} sx={{ alignItems: 'flex-start' }}>
          ...
          {/* Product */}
          <Grid size={{ xs: 6, md: 2 }}>
            <Typography sx={{ fontSize: '0.6875rem', fontWeight: 700, color: '#94a3b8', textTransform: 'uppercase', letterSpacing: '0.1em', mb: 2 }}>
              Product
            </Typography>
            <Box component={Link} to="/request-access" sx={{ display: 'block', mb: 1.25, textDecoration: 'none', fontSize: '0.875rem', color: '#cbd5e1', '&:hover': { color: '#ffffff' } }}>
              Request Access
            </Box>
          </Grid>
          ...
          <Grid size={{ xs: 6, md: 2 }}>
            ...
            {([['Privacy Policy', '/privacy'], ['Terms of Use', '/terms'], ['Security', '/security']] as const).map(([label, to]) => (
              <Box key={label} component={Link} to={to} sx={{ display: 'block', mb: 1.25, textDecoration: 'none', fontSize: '0.875rem', color: '#cbd5e1', '&:hover': { color: '#ffffff' } }}>
                {label}
              </Box>
            ))}
          </Grid>
          ...
          <Grid size={{ xs: 12, md: 4 }}>
            ...
            <Stack sx={{ gap: 1, mb: 3 }}>
              ...
              <Box sx={{ display: 'flex', alignItems: 'baseline', gap: 1.5 }}>
                <Typography sx={{ fontSize: '0.6875rem', fontWeight: 600, color: '#64748b', textTransform: 'uppercase', letterSpacing: '0.06em', flexShrink: 0 }}>Compliance</Typography>
                <Box component="a" href="mailto:compliance@openiv.ng" sx={{ textDecoration: 'none', fontSize: '0.875rem', color: '#cbd5e1', '&:hover': { color: '#ffffff' } }}>
            ...
            <Stack direction="row" sx={{ flexWrap: 'wrap', gap: 1 }}>
              {['CBN', 'NFIU', 'NDPR', 'FATF'].map(badge => (
                <Box key={badge} sx={{ px: 1.25, py: 0.375, border: '1px solid #334155', color: '#94a3b8', fontSize: '0.6875rem', fontWeight: 700, letterSpacing: '0.06em' }}>
                  {badge}
                </Box>
              ))}
            </Stack>
