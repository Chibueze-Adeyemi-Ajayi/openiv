...
export default function AuthLayout({ children, wide = false, narrow = false }: AuthLayoutProps) {
  return (
    <Box
      sx={{
        display: 'flex',
    ...
    >
      ...
      <Box
        sx={{
          ...
          p: narrow ? { xs: 3, sm: 4, md: 4 } : { xs: 3, sm: 4, md: 5, lg: 6 },
          bgcolor: '#ffffff',
          overflowY: 'auto',
          maxHeight: '100vh',
      ...
      >
        <Container
          ...
          sx={{
            width: '100%',
            maxWidth: wide ? '960px !important' : narrow ? '500px !important' : '720px !important',
